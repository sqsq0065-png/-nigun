...
function setGreeting(name){const h=new Date().getHours();const g=h<5?'לילה טוב':h<12?'בוקר טוב':h<17?'צהריים טובים':h<21?'ערב טוב':'לילה טוב';$('#helloTitle').textContent=`${g}, ${name} 👋`}
